...
(async () => {
  ...
  switch (solution) {
    case 'solution-to-review-1':
      module = await import('./reviews/solution-to-review-1/app-ultimate');
      break;
    case 'solution-to-review-2':
      module = await import('./reviews/solution-to-review-2/app-ultimate');
      break;
    case 'your-solution': default:
    module = await import('./your-solution/app-ultimate');
  }
