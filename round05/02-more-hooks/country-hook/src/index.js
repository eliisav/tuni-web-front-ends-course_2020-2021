...
(async () => {
  ...
  switch (solution) {
    case 'solution-to-review-1':
      module = await import('./reviews/solution-to-review-1/app-country');
      break;
    case 'solution-to-review-2':
      module = await import('./reviews/solution-to-review-2/app-country');
      break;
    case 'your-solution': default:
    module = await import('./your-solution/app-country');
  }
