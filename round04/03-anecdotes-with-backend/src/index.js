...
(async () => {
  ...
  switch (solution) {
    ...
    case 'your-solution': default:
      // module = await import('./fullstack-steps/step0/app');
      // module = await import('./fullstack-steps/step1/app');
      // module = await import('./fullstack-steps/step2/app');
      // module = await import('./fullstack-steps/step3/app');
      // module = await import('./fullstack-steps/step4/app');
      // module = await import('./fullstack-steps/step5/app');
      // module = await import('./fullstack-steps/step6/app');
